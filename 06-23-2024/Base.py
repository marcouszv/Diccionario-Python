...
images = ["/static/elm.png","/static/elpe.png","/static/elg.png"]

@app.route("/")
def hello_world():
    return '<h1>Hello, World!</h1> <a href="/User">next</a> <a href="/facts">datos</a>'

@app.route("/facts")
def facts():
    return f'<h1>{random.choice(facts_list)}</h1> <a href="/User">next</a> <a href="/">back</a> <img src={random.choice(images)}>'

@app.route("/User")
def Me():
    return '<h1>Hello, User!</h1> <a href="/">back</a> <a href="/facts">datos</a>'
